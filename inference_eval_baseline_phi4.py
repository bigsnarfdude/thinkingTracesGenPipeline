...
def setup_model():
    ...
    # No LoRA loading - using base model directly
...
def save_results(results, filename="phi4_baseline_results.json"):  # Changed filename
    with open(filename, 'w') as f:
        json.dump(results, f, indent=2)

def load_results(filename="phi4_baseline_results.json"):  # Changed filename
...
def main():
    ...
    print("Setting up baseline Phi-4 model...")
    ...
    total = len(results)
    aggregates = {
        'model': 'Phi-4 Baseline',  # Changed model name
        'total_samples': total,
    ...
    with open("phi4_baseline_metrics.json", 'w') as f:  # Changed filename
